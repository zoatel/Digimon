 ...
 * @author Yaseen
 */
public class searchbfm extends javax.swing.JFrame {
        ...
        if(co == 0){
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    if(Integer.parseInt(rs.getString("BOOK_STOCK")) > 0){
                        bsbi.setText("The Book is : IN-STOCK");
                    }else if(Integer.parseInt(rs.getString("BOOK_STOCK")) == 0){
                        bsbi.setText("The Book is : OUT-OF-STOCK");
                    }
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchbfm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
